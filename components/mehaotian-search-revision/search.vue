<template>
	<view class="content">
		<view class="search-box">
			...
			<mSearch class="mSearch-input-box" :mode="2" button="inside" :placeholder="defaultKeyword" @search="doSearch" @input="inputChange" @confirm="doSearch" v-model="keyword"></mSearch>
