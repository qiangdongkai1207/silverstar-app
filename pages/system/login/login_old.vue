...
<template>
	<view class="login-bg">
		...
		<view class="t-login">
			...
			<form class="cl">
				<view class="t-a">
					<!-- <image src="@/static/image/login/user.png"></image> -->
					<input type="number" name="phone" placeholder="请输入手机号码" maxlength="11" v-model="phone" />
				</view>
				<view class="t-a">
					<!-- <image src="@/static/image/login/pwd.png"></image> -->
		...
		<!-- #endif -->
		<!-- #ifdef MP-WEIXIN -->
		<view class="t-login weixin">
			<view class="t-b">欢 迎 您</view>
			<form class="cl">
				<button @tap="loginWeixin()">一 键 微 信 登 录</button>
			</form>
		</view>
		<!-- #endif -->
		<image class="img-b" src="@/static/image/login/bg2.png"></image>
	</view>
</template>
<script>
	export default {
